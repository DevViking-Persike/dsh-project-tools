...
export type EditorLanguageServersValue = {
    servers: readonly EditorLanguageServer[];
};
/** Parameters for editor.listDir. */
export type EditorListDirRequest = {
    sessionId?: SessionId;
    path?: string;
};
...
export type EditorReadFileRequest = {
    sessionId?: SessionId;
    path: string;
};
...
export type DockerEngineStatusValue = {
    status: DockerEngineStatusView;
};
/** Parameters for docker.startEngine. */
export type DockerStartEngineRequest = {};
/** Result of docker.startEngine. */
export type DockerStartEngineValue = {
    status: DockerEngineStatusView;
    output: string;
};
...
export type DockerComposeDownRequest = {
    file: string;
    project?: string;
};
...
export type TreadmillUpdateStageValue = {
    id: string;
    tableSource: 'project' | 'global';
};
/** Parameters for treadmill.saveToProject. */
export type TreadmillSaveToProjectRequest = {
    sessionId: SessionId;
    path: string;
    content: string;
};
/** Result of treadmill.saveToProject. */
export type TreadmillSaveToProjectValue = {
    path: string;
};
